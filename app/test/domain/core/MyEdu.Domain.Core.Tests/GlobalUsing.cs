global using MockData = MyEdu.Domain.Core.Tests.Data;
namespace MyEdu.Domain.Core.Tests;
...
public static class Data
{
    ...
    public static readonly DateTimeOffset Date = DateTimeOffset.Now.AddDays(-1);
}
